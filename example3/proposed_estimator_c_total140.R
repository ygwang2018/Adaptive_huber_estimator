...
for (power_parmater in  power_parmater_lis) {
  ...
  for (i in 1:1000) {
    ...
    res <- abs_normal_q(c_seg = 49+1, total_node = 140, alpha =1, power = power_parmater)
    knot_vec <- res$q
...
write.csv(df, "C:/Users/PC/Desktop/modified_huber/example3/diff_power_results_totalnode140.csv", row.names = FALSE)
