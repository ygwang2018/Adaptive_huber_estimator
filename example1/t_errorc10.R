...
for (tau in tau_lis){
  ...
  for (i in 1:n_rep) {
    ...
    res <- abs_normal_q(c_seg = 10, total_node =200, alpha =0.8, power = 4)$q
    c=10
...
write.csv(df, "C://Users//PC//Desktop//modified_huber//example2//mse_bias_summary_c10.csv", row.names = FALSE)
