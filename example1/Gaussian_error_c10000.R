...
for (tau in tau_lis){
  ...
  for (i in 1:n_rep) {
    ...
    res <- abs_normal_q(c_seg = 10000, total_node =50000, alpha =1, power = 1.1)$q
    c=10000
...
write.csv(df, "C://Users//PC//Desktop//modified_huber//example2//eff_bias_summary_c10000.csv", row.names = FALSE)
