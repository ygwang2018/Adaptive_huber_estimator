...
total_Huber_MSE_lis <- c(); total_Huber_bias_lis <- c()
total_Mohuber_MSE_lis <- c(); total_Mohuber_bias_lis <- c()
...
for (tau in tau_lis){
  ...
  for (i in 1:n_rep) {
    ...
    res <- abs_normal_q(c_seg = 150, total_node =200, alpha =0.8, power = 4)$q
    c=150
  ...
  total_Huber_MSE_lis <- c(total_Huber_MSE_lis, mean(Huber_MSE_lis))
  total_Huber_bias_lis <- c(total_Huber_bias_lis,mean(Huber_bias_lis))
  
  total_Mohuber_MSE_lis <- c(total_Mohuber_MSE_lis, mean(Mohuber_MSE_lis)) 
  total_Mohuber_bias_lis <- c(total_Mohuber_bias_lis,mean(Mohuber_bias_lis))
  
}
df <- data.frame(
  tau = tau_lis,
  Huber_MSE = total_Huber_MSE_lis,
  Huber_Bias = total_Huber_bias_lis,
  MoHuber_MSE = total_Mohuber_MSE_lis,
  MoHuber_Bias = total_Mohuber_bias_lis
)

write.csv(df, "C://Users//PC//Desktop//modified_huber//example2//mse_bias_summaryc_150.csv", row.names = FALSE)
